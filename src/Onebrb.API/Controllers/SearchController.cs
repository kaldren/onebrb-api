...
namespace Onebrb.API.Controllers
{
    ...
    public class SearchController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Profile>>> SearchProfilesAsync()
        {
            ...
            {
                new Profile {Id = Guid.NewGuid().ToString(), FirstName = "John", LastName="Doe", Email = "john@example.com", About = "Number one plumber in Veliko Varnovo", Phone = "0888 123456"},
                new Profile {Id = Guid.NewGuid().ToString(), FirstName = "John", LastName="Boe", Email = "johnb@example.com", About = "Number two plumber in Veliko Varnovo", Phone = "0888 222456"},
                new Profile {Id = Guid.NewGuid().ToString(), FirstName = "John", LastName="Soe", Email = "johns@example.com", About = "Number three plumber in Veliko Varnovo", Phone = "0888 333456"},
